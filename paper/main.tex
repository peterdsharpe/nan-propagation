...
\title{Sparsity Tracing of Black-Box Computational Functions via NaN-Propagation}

\author[1]{Peter Sharpe}
...
\vspace{-0.5cm}
\begin{center}
\small\textit{This manuscript is an adaptation of a chapter from the author's PhD thesis \cite{sharpeAcceleratingPracticalEngineering2024}.}
\end{center}
\vspace{0.5cm}
