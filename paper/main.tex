...
\vspace{-0.5cm}
\begin{center}
\small\textit{This manuscript is an adaptation of a chapter from the author's PhD thesis \cite{sharpeAcceleratingPracticalEngineering2024}, with additional context to facilitate independent reading.}
\end{center}
\vspace{0.5cm}
